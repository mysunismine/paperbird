...
DEFAULT_IMAGE_PROMPT_TEMPLATE = (
    "You are an assistant helping an editor create an image generation prompt for a news story.\n"
    "Based on the context below, suggest a short, visual prompt (1-2 sentences, in English).\n"
    "Requirements:\n"
    "- The prompt must be in English.\n"
    "- Do not specify image size, format, resolution, or rendering styles.\n"
    "- Focus on the key visual elements of the story.\n"
    "- Avoid mentioning specific brands, personal data, or logos.\n"
    "- Your response must be strictly in JSON format: {\"prompt\": \"...\"}\n"
    "\n"
