        ...
        source_payloads.append(
            {
                ...
                "web_request_interval_sec": source.web_request_interval_sec,
                "web_request_jitter_sec": source.web_request_jitter_sec,
                "web_max_items_per_run": source.web_max_items_per_run,
                "web_block_cooldown_sec": source.web_block_cooldown_sec,
