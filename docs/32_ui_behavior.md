...
- Фильтры: по дате, источнику, статусу обработки.
...
- Кнопка «Сгенерировать изображение» располагается под текстом сюжета.
- Нажатие открывает всплывающее окно с полем комментария и кнопкой отправки.
- После генерации картинка отображается с возможностью:
  ...
  - удалить
- Можно прикрепить только одну картинку к сюжету.
- Если изображение не прикреплено — оно не сохраняется.
