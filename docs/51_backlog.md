...
- [x] Добавить поля «Название» и «Теги» при загрузке медиа, чтобы улучшить качество поиска.
- [x] Добавить краткую подсказку в UI медиабиблиотеки о том, что поиск работает по названию, промпту и тегам.
...
- [x] Массовое редактирование тегов и названий медиа (bulk-режим для библиотек с большим объёмом ассетов).
