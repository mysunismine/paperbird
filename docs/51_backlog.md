...
- Перенести URL ленты `/projects/<id>/posts/` в отдельный раздел (например, `/feed/<project_id>/`) и обновить навигацию под новое расположение.
...
- В шаблоне страницы работы с сюжетом http://127.0.0.1:8000/stories/6/ Нужно убрать кнопку "К списку".
