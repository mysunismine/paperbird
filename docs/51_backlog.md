...
- Реализовать автоматическое добавление в промт, который отправляется в gpt-модель, текущую дату. Добавить в настройках проекта локаль и UTC время, чтобы использовать время пользователя.
...
- Добавить возможность открывать полностью конкретную новость в ленте (detail странцу).
---
