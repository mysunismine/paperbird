...
- Сделать так, чтобы сборщик постов работал за всех имеющихся пользователей сразу.
- Добавить полноценное отображение медиафайлов в постах в ленте проекта http://127.0.0.1:8000/feed/{n}/
---
